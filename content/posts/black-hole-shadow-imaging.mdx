...
<GearBox title="Further reading">
  <GearPick name="Black holes & the Event Horizon Telescope (book)" href="https://www.amazon.com/s?k=black+hole+event+horizon+telescope+book" why="the science and the story behind the first image" />
  <GearPick name="Astrophysics for People in a Hurry (book)" href="https://www.amazon.com/s?k=astrophysics+for+people+in+a+hurry" why="a fast, friendly grounding in the physics" />
  <GearPick name="Kip Thorne — Black Holes & Time Warps (book)" href="https://www.amazon.com/s?k=kip+thorne+black+holes+time+warps" why="the deep dive from a Nobel laureate" />
</GearBox>
